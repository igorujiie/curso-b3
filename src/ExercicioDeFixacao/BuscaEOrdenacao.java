...
// organização para melhor entender os dados. Como exemplo podemos citar uma chamada em classe. Geralmente,
// esse procedimento segue o padrão da ordem alfabética, isto é, uma forma de ordenação.
//
