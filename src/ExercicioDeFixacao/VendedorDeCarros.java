...
Faça uma função que recebe um array com:

quantidade de carros vendidos por ele no mês, o valor total de suas vendas no mês, seu salário fixo, valor fixo que
recebido por carro vendido. Calcule e retorne qual o salário dele(salário fixo mais comissões).

Arredonde o valor de retorno para duas casas decimais.


Ex:
         [qtdVendida, valorTotal, salarioFixo, valorFixoPorCarro]
